...
public class GameData : MonoBehaviour
{
    ...
    public void SaveItemInventryDatas()
    {
        ...
        for (int i = 0; i < itemInventryDatasList.Count; i++)
        {
            ...
            Debug.Log(itemInventryDatasList[i].itemName.ToString());
            Debug.Log(itemInventryDatasList[i].itemName.ToString() + "," + itemInventryDatasList[i].count.ToString() + "," + i.ToString());
        }
            // セーブ
            PlayerPrefs.Save();
